  ...
  return (
    <div className={`w-full ${className}`}>
      ...
      <div className="w-full h-6 bg-muted rounded-full overflow-hidden flex">
        {/* Male bar */}
        <div 
          className="bg-primary/50 h-full flex items-center justify-center transition-all duration-300"
        ...
        {/* Female bar */}
        <div 
          className="bg-chart-5/50 h-full flex items-center justify-center transition-all duration-300"
      ...
      <div className="flex items-center justify-between mt-2 text-xs text-muted-foreground">
        <div className="flex items-center gap-1">
          <Mars className="size-3 text-primary" />
          <span>Male: {male} ({malePercentage.toFixed(1)}%)</span>
        </div>
        <div className="flex items-center gap-1">
          <Venus className="size-3 text-chart-5" />
